...
class Pages extends Controller
{
    ...
    public function index()
    {
        ...
        $data = [
            'title' => 'Travel Share',
            'subtitle' => 'A experience that is worth sharing, Help others discover new places and have a new experience
    ...
    public function about(){
        $data = [
            'title' => 'About Travel Share',
            'subtitle' => ' Travel Share was a simple social networking site that was build to connect
