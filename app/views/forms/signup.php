    ...
    <div class="body grid md:grid-cols-2 justify-around">
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
            ...
            <div class="relative z-0 mb-6 w-full group">
                <!-- First name -->
                <input type="text" name="firstname" id="firstname" class="peer block w-full appearance-none border-0 border-b-2
                 border-gray-300 bg-transparent py-2.5 px-0 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0 dark:border-gray-600 dark:text-white dark:focus:border-blue-500 <?php echo (!empty($data['firstname_err'])) ? 'border-b-red-600': '';?>" 
                value="<?php echo $data['firstname'] ?? '';?>"/>
                <label for="firstname" class="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm
                 ...
                 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:font-medium peer-focus:text-blue-600
                  dark:text-gray-400 peer-focus:dark:text-blue-500">First name</label>
